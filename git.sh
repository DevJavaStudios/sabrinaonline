...
echo "           ==============" $merah
echo "     ____________"
echo " ___| SabrinaBOT By __| " $putih
echo "|  Dev Java__|"
...
echo " Nota : $putih Sabrina Precisa da sua Permissão"
echo "         Para Instalar as funções Sabrina,"
...
clear
sleep 2
echo "          $merah   instalando a SabrinaBOT"
sleep 2
cd $HOME
